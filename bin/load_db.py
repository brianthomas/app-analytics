...
#            "OS Version": "os_version_map",\
    ...
    data['fips_199_cat_id'] = data['FIPS 199 Category'].replace(fips_dict)
    data['impact_id'] = data['Impact'].replace(impact_dict)
    data['vuln_scan_date_id'] = data['Vulnerability Scan Date'].replace(date_dict)
    data['vuln_identifier_id'] = data['Vulnerability Identifier'].replace(vuln_dict)
